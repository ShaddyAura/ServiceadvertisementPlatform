...
{
    /// <inheritdoc />
    public partial class Addinitoaldatabase : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PointsRequired = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BoostingPoints = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    LifetimePoints = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "DocumentVerifieds",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProfileId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DocumentType = table.Column<int>(type: "int", nullable: false),
                    DocumentFrontSideUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DocumentBackSideUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocumentVerifieds", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DocumentVerifieds_Profiles_ProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RedeemedGifts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RedeemedGifts_Gifts_GiftId",
                        column: x => x.GiftId,
                        principalTable: "Gifts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RedeemedGifts_Profiles_ProfileId",
                        column: x => x.ProfileId,
                        principalTable: "Profiles",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BoostLevel = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LifetimePurchasedPoints = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    ESewaBalance = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    KhaltiBalance = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountDetails = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WithdrawalRequests_Profiles_ProfileId",
                        column: x => x.ProfileId,
                        principalTable: "Profiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "BoostingTransactions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ServiceId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PointsSpent = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    BoostStartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    BoostEndDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BoostingTransactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BoostingTransactions_ServiceListings_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "ServiceListings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PointsTransactions_Wallets_WalletId",
                        column: x => x.WalletId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BoostingTransactions_ServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentVerifieds_ProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PointsTransactions_WalletId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RedeemedGifts_GiftId",
                table: "RedeemedGifts",
                column: "GiftId");

            migrationBuilder.CreateIndex(
                name: "IX_RedeemedGifts_ProfileId",
                table: "RedeemedGifts",
                column: "ProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WithdrawalRequests_ProfileId",
